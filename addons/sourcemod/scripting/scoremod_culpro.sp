...
public OnPluginStart()
{
	...
	hCvarPillsBonusFactor = CreateConVar("am_items_pills_bonus_factor", "0.08", "Unused pills can gain this * Map Distance", FCVAR_NONE, true, 0.0, true, 1000.0);
	hCvarAllowAdrenaline = CreateConVar("am_items_bonus_allow_adrenaline", "0", "Are we allow adrenaline as the part of scoring");
	...
	hCvarMedBonusFactor = CreateConVar("am_items_med_bonus_factor", "0.16", "Unused Medkits can gain this * Map Distance", FCVAR_NONE, true, 0.0, true, 1000.0);
	...
	hCvarTempTotal = CreateConVar("am_temp_total", "160", "We consider the max of the survivor team's temp health", FCVAR_NONE, true, 1.0, true, 10000.0);
	...
	hCvarIncapPenalty = CreateConVar("am_incap_penalty", "8", "When someone is incapped, we reduce the tempbonus", FCVAR_NONE, true, 1.0, true, 1000.0);
	...
	hCvarDeathPenaltyFactor = CreateConVar("am_death_penalty_factor", "0.33", "Reduce the Bonus when someone died", FCVAR_NONE, true, 0.0, true, 1.0);
	hCvarDeathMininumPenalty = CreateConVar("am_death_min_penalty", "0.0", "The mininum bonus will be reduced when someone died", FCVAR_NONE, true, 0.0);
...
public Action:CmdBonus(client, args)
{
	...
	new Float:fItemsMaxBonus = float(iMedWorth * iTeamSize);
...
public Action:CmdMapInfo(client, args)
{
	...
	new Float:fItemsMaxBonus = fMaxMedBonus;
